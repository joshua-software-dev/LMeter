...
public class BarConfig : IConfigPage
{
    ...
    public ConfigColor BarColor = new (r: .3f, g: .3f, b: .3f, a: 1f);
    ...
    public ConfigColor RankTextColor = new (r: 1, g: 1, b: 1, a: 1);
    public bool RankTextShowOutline = true;
    public ConfigColor RankTextOutlineColor = new (r: 0, g: 0, b: 0, a: 0.5f);
    ...
    public ConfigColor BarNameColor = new (r: 1, g: 1, b: 1, a: 1);
    public bool BarNameShowOutline = true;
    public ConfigColor BarNameOutlineColor = new (r: 0, g: 0, b: 0, a: 0.5f);
    ...
    public ConfigColor BarDataColor = new (r: 1, g: 1, b: 1, a: 1);
    public bool BarDataShowOutline = true;
    public ConfigColor BarDataOutlineColor = new (r: 0, g: 0, b: 0, a: 0.5f);
    ...
    public IConfigPage GetDefault() =>
        new BarConfig
        {
            ...
            BarNameFontId = PluginManager.Instance.FontsManager.GetFontIndex(FontsManager.DefaultSmallFontKey),

            BarDataFontKey = FontsManager.DefaultSmallFontKey,
            BarDataFontId = PluginManager.Instance.FontsManager.GetFontIndex(FontsManager.DefaultSmallFontKey),

            RankTextFontKey = FontsManager.DefaultSmallFontKey,
            RankTextFontId = PluginManager.Instance.FontsManager.GetFontIndex(FontsManager.DefaultSmallFontKey)
        };
    ...
    {
        var barHeight = (size.Y - (this.BarCount - 1) * this.BarGaps) / this.BarCount;
        ...
        {
            var jobIconId = 62000u + (uint) combatant.Job + 100u * (uint) this.JobIconStyle;
        ...
        {
            var rankText = combatant.GetFormattedString
            (
                $"{this.RankTextFormat}",
        ...
        {
            var playerName = PluginManager.Instance.ClientState.LocalPlayer?.Name.ToString() ?? "YOU";
            if (this.UseCharacterName && combatant.Name.Contains("YOU"))
            {
                combatant.Name = playerName;
            }

            var leftText = combatant.GetFormattedString
            (
                $" {this.LeftTextFormat} ",
                this.ThousandsSeparators ? "N" : "F"
            );
        ...
        {
            var rightText = combatant.GetFormattedString
            (
